...
<section class="content">
    <div class="box box-danger">
        <div class="box-header">
            <h3 class="box-title">แสดงข้อมูลหน่วยงาน</h3>
        </div>
        <form class="box-body" id="frm-data" enctype="multipart/form-data" action="pages/user-office-show/action.php" method="post">
            ...
            <?php } ?>
            <?php if($_SESSION["table"]=="tb_office") { ?>
                <a class="btn btn-warning" href="?content=user-office-edit&id=<?php echo $_SESSION["data_id"]; ?>" title="แก้ไขข้อมูล"><i class="fa fa-edit"></i> แก้ไขข้อมูล</a>
            <?php } ?>
