        ...
        <div class="box-body">
            ...
            <div class="btn-group" title="พิมพ์ข้อมูล">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="#">ชุดหนังสือแบบเริ่มเรียนมูลาบาฮาซา (ระดับชั้นประถมศึกษา)</a></li>
                    <li role="separator" class="divider"></li>
                </ul>
            </div>
                            ...
                            <?php
                                $sql = "
                                    SELECT
                                        ...
                                        tb_get_book.book_id,
                                        tb_get_book.qty As BOOK_QTY,
                                        tb_type_book.`name`,
                                        tb_book.name_thai As BOOK_THAI,
                                        tb_book.book_type_id
                                        FROM
                                        tb_get_book
                                        INNER JOIN tb_book ON tb_get_book.book_id = tb_book.book_id AND tb_get_book.type_book_id = tb_book.book_type_id
