...
<section class="content">
    <div class="box box-danger">
        <div class="box-header">
            <h3 class="box-title"> ข้อมูลการแจกจ่ายหนังสือ</h3> > แบบเริ่มเรียนมูลาบาฮาซา
            <div style="margin-top: 15px;">
                <form action="./" method="get" class="form-inline">
                    <input type="hidden" name="content" value="book-distribute-mulabahasa">
                    <input type="hidden" name="page" value="<?php echo $PAGE; ?>">
                    <a href="?content=book-distribute-mulabahasa-add" class="btn btn-success" title="เพิ่มข้อมูล">
                        <i class="fa fa-plus"></i> เพิ่มข้อมูล</a>
                    <button type="button" class="btn btn-default" onClick="location.href='?content=book-distribute-mulabahasa'" title="รีเฟรส"><i class="fa fa-refresh"></i> รีเฟรส</button>
        ...
        <div class="box-body" style="margin-top: 0px;">
            <div class="table-responsive">
                <?php
                    ...
                    $start = ($PAGE-1)*$SHOW;
                    $condition = "";
                        if( $SERACHING==NULL ) $condition = " AND tb_get_book.type_book_id = '3'
                    ";
                    $sql = "    
                        SELECT
                            tb_get_book.id,
                            ...
                            foreach($DATA as $key => $row){
                                ...
                                <tr>
                                    ...
                                    <td style="margin-right: 3px; text-align: right;">
                                        ...
                                        <a class="btn btn-success btn" href="report/report-teacher-mulabahasa/view.php?id=<?php echo $row['teacher_id'];?>" title="พิมพ์ข้อมูล" style="background-color: #ff65a5; border-color: #ff65a5;" target="_blank"><i class="fa fa-print"></i>
                                        </a>
                                    </td>             
                                </tr>
                                <?php 
                ...
                <div>จำนวนข้อมูลทั้งหมด <?php echo $all;?> คน</div>
                <?php
                    $searhing = "";
                    if( $SERACHING!="" ) {
                    ...
                    $disabled1 = '';
                    $disabled2 = '';
                    $href1 = 'href="?content=book-distribute-mulabahasa&page='.($PAGE-1).$searhing.'"';
                    $href2 = 'href="?content=book-distribute-mulabahasa&page='.($PAGE+1).$searhing.'"';
