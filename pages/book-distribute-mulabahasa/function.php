<?php
    ...
    function setCurrentStep($currStep) {
        ...
        if( $content=="book-distribute-mulabahasa".$currStep ) return "current";
        return "";
    }
 ...
 <script type="text/javascript">
    ...
    $(function() {
        ...
        if( content=="?content=book-distribute-mulabahasa-add" ) currStep = 2;
    ...
    function goStep(step) {
        ...
        $("#myForm").attr("action","?content=book-distribute-mulabahasa-"+step);
