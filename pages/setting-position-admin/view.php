...
<section class="content-header">
    <h1>ตั้งค่าข้อมูลตำแหน่ง<small>การจัดการข้อมูลตำแหน่ง</small></h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> การจัดการข้อมูลตำแหน่ง</a></li>
    </ol>
</section>
<section class="content">
    <div class="box box-danger">
        <div class="box-header">
          	<h3 class="box-title">การจัดการข้อมูลตำแหน่ง</h3>
        </div>
        <div class="box-body"> 
        	...
        	<?php
        		...
        		function showAlert($message) {
        			echo '
        				<script>
        					alert("'.$message.'");
        					location.href="./?content=setting-position-admin";
        				</script>
        			';
        		}

        		if( isset($_POST["btnAdd"]) ) {
        			$id = $DATABASE->QueryMaxId("tb_position","id");
        			$name = $_POST["name"];
        			$sql = "
        	...
        	?>
        	<form class="form-horizontal" action="./?content=setting-position-admin" method="POST" onsubmit="return onSubmit();">
			  	<div class="form-group">
			    	<label for="id" class="col-sm-2 control-label">รหัสตำแหน่ง</label>
			    	<div class="col-sm-6">
			      		<input type="text" class="form-control" id="id" name="id" placeholder="รหัสตำแหน่ง" readonly="readonly">
			    	</div>
			  	</div>
			  	<div class="form-group">
			    	<label for="name" class="col-sm-2 control-label">ชื่อตำแหน่ง</label>
			    	<div class="col-sm-6">
