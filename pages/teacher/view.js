$(function() {
    function loadCw() {
        $.post('pages/teacher/services.php', { fn: "loadCw" }, function(data) {
    ...
    function loadAp() {
        ...
        $.post('pages/teacher/services.php', { fn: "loadAp", cw_id: cw_id }, function(data) {
            var arr = JSON.parse(data);
    ...
    function loadTb() {
        ...
        $.post('pages/teacher/services.php', { fn: "loadTb", cw_id:cw_id, ap_id: ap_id }, function(data) {
            var arr = JSON.parse(data);
    ...
    function loadPc() {
        var cw_id = $("[name='province_id_']").val();
        var ap_id = $("[name='amphur_id_']").val();
        $.post('pages/teacher/services.php', { fn: "loadPc", cw_id:cw_id, ap_id: ap_id }, function(data) {
