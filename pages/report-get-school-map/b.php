                    ...
                    $.ajax({
                        ...
                        if(json.length > 0){
                            ...
                            for(var i = 0 ;i<json.length;i++){
                                ...
                                t +='    <table id="myTable" class="table table-hover">';
                                t +='        <thead>';
                                t +='            <tr style="background-color: #7a0c0c; color: #fff;">';
                                t +='                <th><center>ลำดับ</center></th>';
                                t +='                <th>ชื่อโรงเรียน</th>';
                                t +='                <th>ที่อยู่โรงเรียน</th>';
                                t +='                <th>โทร</th>';
                                t +='                <th><center>พิกัด</center></th>';
                                t +='            </tr>';
                                t +='        </thead>';
                                t +='        <tbody>';
                                t +='                        <tr>';
                                t +='                            <td><center><?php $key = 1; echo $key++; ?></center></td>';
                                t +='                            <td>'+ json[i].name + '</span></td>';
                                t +='                            <td>ตำบล '+ json[i].district + ' อำเภอ ' + json[i].amphur + ' จังหวัด ' + json[i].province + '</td>';
                                t +='                            <td>โทร '+ json[i].tel +'</td>';
                                t +='                            <td>พิกัด '+ json[i].lat + ' - '+ json[i].lng +'</td>';
                                t +='                        </tr>';
                                t +='        </tbody>';
                                t +='    </table>';
                                t +='</div>';
