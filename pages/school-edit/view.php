...
<section class="content">
    <div class="box box-danger">
        <div class="box-header">
            <h3 class="box-title">แก้ไขข้อมูลโรงเรียน</h3> > <small><?php $SCHOOL_NAME = $DATABASE->QueryString("SELECT name FROM tb_school WHERE id='".$data['id']."'"); echo $SCHOOL_NAME;?></small>
        </div>
        <form class="box-body" id="frm-data" enctype="multipart/form-data" action="pages/school-edit/action.php" method="post">
            ...
            <a class="btn btn-danger btn" href="?content=school-del&id=<?php echo $data['id']; ?>&page=<?php echo $PAGE; ?>" title="ลบข้อมูล"><i class="fa fa-trash"></i> ลบข้อมูล</a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="code" id="code" placeholder="รหัสโรงเรียน" data-inputmask="'mask': '9999999999'" value="<?php echo $data['code'];?>" required>
                            <small><red>เช่น 1234567890 (ไม่ต้องใส่ขีด -)</red></small>
                        </div>
                        <div class="form-group">
                            <label for="name">ชื่อโรงเรียน <red>*</red></label>
                            <input type="text" class="form-control" name="name" placeholder="ชื่อโรงเรียน" value="<?php echo $data['name'];?>" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="road" placeholder="ซอย" value="<?php echo $data['road'];?>">
                                <small><red>เช่น - </red></small>
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="latitude" placeholder="ละติจูด" value="<?php echo $data['lat'];?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="longitude" class="col-sm-3 control-label">ลองจิจูด </label>
                                <input type="text" class="form-control" name="longitude" placeholder="ลองจิจูด" value="<?php echo $data['lng'];?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="department_id" name="department_id" required class="form-control selectpicker" data-live-search="true" title="เลือกสำนักงานเขตพื้นที่การศึกษา" style="width: 100%;" required>
                                    ...
                                    foreach($obj as $row) {
                                        $selected = "";
                                        if( $data["department_id"]==$row["id"] ) $selected = "selected";
                                        echo '<option value="'.$row["id"].'" '.$selected.' >'.$row["name"].'</option>';
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="area_id" name="area_id" required class="form-control selectpicker" data-live-search="true" title="เลือกสังกัด" style="width: 100%;" required>
                                    ...
                                    foreach($obj as $row) {
                                        $selected = "";
                                        if( $data["area_id"]==$row["id"] ) $selected = "selected";
                                        echo '<option value="'.$row["id"].'" '.$selected.' >'.$row["name"].'</option>';
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="row">                    
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="website" placeholder="เว็บไซต์" value="<?php echo $data['website'];?>" required>
                                <small><red>เช่น http://yru.ac.th/</red></small>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tel">เบอร์โทรมือถือ / โทรสาร</label>
                            <input type="text" class="form-control" name="tel" placeholder="เบอร์โทรมือถือ" data-inputmask="'mask': '999-9999999'" value="<?php echo $data['tel'];?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="prefix_id" name="prefix_id" class="form-control selectpicker" data-live-search="true" title="เลือกคำนำหน้า" style="width: 100%; " required>
                                ...
                                foreach($obj as $row) {
                                    $selected = "";
                                    if( $data["prefix_name"]==$row["name"] ) $selected = "selected";
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="boss_name" placeholder="ชื่อภาษาไทย" value="<?php echo $data['boss_name'];?>" required>
                            <small><red>เช่น เอบีซี</red></small>
                        </div>
                        <div class="form-group">
                            <label for="boss_lname">สกุลภาษาไทย <red>*</red></label>
                            <input type="text" class="form-control" name="boss_lname" placeholder="สกุลภาษาไทย" value="<?php echo $data['boss_lname'];?>" required>
