...
<section class="content-header">
        <h1><i class="glyphicon glyphicon-book"></i> การจัดการข้อมูลวาระ<small></small></h1>
        <ol class="breadcrumb">
            <li><a href="./"><i class="glyphicon glyphicon-home"></i> หน้าแรก</a></li>
            <li><a href="?content=<?php echo $content; ?>">การจัดการข้อมูลวาระ</a></li>
        </ol>
    </section>
<section class="content">
    <div class="box box-danger">
        ...
        <form class="box-body" id="frm-data" enctype="multipart/form-data" action="./?content=meeting-add" method="POST" onsubmit="return onSubmit();">
            <a href="?content=meeting" class="btn btn-default" title="กลับ"><i class="fa fa-arrow-left"></i> กลับ</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12" align="center">
                    <input class="w3-input w3-animate-input text-center" id="name" name="name" type="text" align="center" style="width:90%" title="วาระที่" placeholder="วาระที่"><br>
                    <input class="w3-input w3-animate-input text-center" id="description" name="description" type="text" align="center" style="width:90%" title="ชื่อวาระ" placeholder="ชื่อวาระ"><br>
