                ...
                <div class="box-body" style="margin-top: 0px;">
                    <div class="row">
                        <div align="center">
                            ...
                            ?></p>
                            <input class="w3-input w3-animate-input text-center" type="text" style="width:160px" title="วันที่" placeholder="วันที่" id="date_start" name="date_start" required value="วันที่ <?php echo DateThai($strDate);?>">
