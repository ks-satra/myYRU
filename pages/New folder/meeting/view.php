                        ...
                        if(sizeof($DATA)>0){
                            foreach($DATA as $key => $row){
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-info btn-sm" href="?content=meeting-description&id=<?php echo $row['id']; ?>&page=<?php echo $PAGE; ?>" title="จัดการข้อมูล"><i class="fa fa-cog"></i> จัดการข้อมูล</a>
                                    </td>
                                    <?php 
                                }
                        }else{
