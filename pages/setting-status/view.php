...
<section class="content-header">
    <h1>ตั้งค่าข้อมูลสถานะ<small>การจัดการข้อมูลสถานะ</small></h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> การจัดการข้อมูลสถานะ</a></li>
    </ol>
</section>
<section class="content">
    <div class="box box-danger">
        <div class="box-header">
          	<h3 class="box-title">การจัดการข้อมูลสถานะ</h3>
        </div>
        <div class="box-body"> 
        	...
        	<?php
        		...
        		function showAlert($message) {
        			echo '
        				<script>
        					alert("'.$message.'");
        					location.href="./?content=setting-status";
        				</script>
        			';
        		}

        		if( isset($_POST["btnAdd"]) ) {
        			$id = $DATABASE->QueryMaxId("tb_status","id");
        			$name = $_POST["name"];
        			$sql = "
        	...
        	?>
        	<form class="form-horizontal" action="./?content=setting-status" method="POST" onsubmit="return onSubmit();">
			  	<div class="form-group">
			    	<label for="id" class="col-sm-2 control-label">รหัสสถานะ</label>
			    	<div class="col-sm-6">
			      		<input type="text" class="form-control" id="id" name="id" placeholder="รหัสสถานะ" readonly="readonly">
			    	</div>
			  	</div>
			  	<div class="form-group">
			    	<label for="name" class="col-sm-2 control-label">ชื่อสถานะ</label>
			    	<div class="col-sm-6">
			      		<input type="text" class="form-control" id="name" name="name" placeholder="ชื่อสถานะ" required="required">
			    	</div>
			  	</div>
			  	<div class="form-group">
