                        ...
                        if(sizeof($DATA)>0){
                            foreach($DATA as $key => $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-sm" href="?content=project-activity-class&project_id=<?php echo $row['project_id'];?>&page=<?php echo $PAGE; ?>" title="ตรวจสอบกิจกรรม"><i class="fa fa-eye"></i> ตรวจสอบกิจกรรม</a>
                                    </td>             
                                </tr>
                                <?php 
                            }
