...
<body style="font-family: Garuda;">
    ...
    <br><br><br><br><br><br>
    <p align="center"><img src="../../files/img/aa.gif" alt="" width="9%" height="11%" /></p>
    <p align="center" style="padding-top: -20px; font-size: 14px;"><b>เอกสารรับมอบสมุดธนาคารหนังสือนิทาน</b></p>
    <p style="padding-top: -20px; font-size: 14px;" align="center"><b>ชุดสมุดธนาคารนิทานคุณธรรมจากวรรณกรรมในฝักกริช (Bookbank)</b></p>
    <div style="padding-top: -20px;"></div>
    <table style="height: 51px; width: 100%; border-collapse: collapse;" border="0">
        <tbody>
            <tr style="height: 17px;">
                ...
                <?php
                    $sql = "
                        ...
                        FROM
                            tb_get_book
                            INNER JOIN tb_book ON tb_get_book.book_id = tb_book.id
                        WHERE tb_get_book.teacher_id = '".$id."' AND tb_get_book.type_book_id = '2'
                            ...
                            if(sizeof($DATA)>0){ 
                                foreach($DATA as $key => $row){
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <?php if($row['qty'] == 1) { ?>
                                                <td valign="top"><p>&nbsp;</p><center><?php echo $key+1; ?></center></td>
                                                <td height="30" style="padding-left: 5px" valign="top"><p>&nbsp;</p><?php echo $row['BOOK_THAI'];?></td>
                                                <td height="30" align="center" valign="top"><p>&nbsp;</p><?php echo $row['qty'];?></td>
                                                <td>
                                                    <p>&nbsp;</p>
                                                    <p>&nbsp;</p>
                                                    <p>&nbsp;</p>
